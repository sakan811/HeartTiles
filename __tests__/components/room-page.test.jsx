...
describe("RoomPage Component", () => {
  ...
  describe("Component Rendering", () => {
    ...
    it("should show share room code message", () => {
      ...
      expect(
        screen.getByText("Share the room code with a friend to join the game!"),
      ).toBeInTheDocument();
    });
    ...
    it("should show waiting for another player message", () => {
      ...
      expect(
        screen.getByText("Waiting for another player to join..."),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Player Display", () => {
    ...
    it("should show green ring around ready players", async () => {
      ...
      const playerCard = (await screen.findByText("Alice")).closest(
        '[class*="bg-white"]',
      );
  ...
  describe("Player Count Messages", () => {
    it('should show "Need 1 more player" when there is 1 player', async () => {
      ...
      expect(
        await screen.findByText("Need 1 more player to start!"),
      ).toBeInTheDocument();
    });
    ...
    it('should show "No players in room yet" when joined but no players', async () => {
      ...
      expect(
        await screen.findByText("No players in room yet"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Component Structure and Layout", () => {
    it("should have proper CSS classes and styling", () => {
      ...
      const cardElement = container.querySelector(
        '[class*="bg-white"][class*="backdrop-blur"][class*="rounded"][class*="p-8"]',
      );
