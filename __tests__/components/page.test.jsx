...
describe("Home Page Component", () => {
  ...
  it("should open join dialog when Join Room button is clicked", async () => {
    ...
    expect(
      screen.getByText("Enter the room code to join an existing game"),
    ).toBeTruthy();
  ...
  describe("Join Room Dialog", () => {
    ...
    it("should close dialog when Cancel button is clicked", () => {
      ...
      expect(
        screen.queryByText("Enter the room code to join an existing game"),
  ...
  describe("Dialog Modal Behavior", () => {
    ...
    it("should render dialog with proper modal backdrop", () => {
      ...
      const dialog = screen
        .getByText("Enter the room code to join an existing game")
        .closest("div");
